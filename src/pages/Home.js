...
import phlogo from '../assets/images/icon/bluephone.png'
import lock from '../assets/images/icon/bluelock.png'
import download from '../assets/images/icon/download-1.png'
import sponsorlogo1 from '../assets/images/pictures/sponsorlogo1.png'
import phone7 from '../assets/images/pictures/phone7.png'
import AlexHansinburg from '../assets/images/pictures/bobbysammy.png'
    ...
    return (
        <>
                ...
                <nav>
                    <div className="nav-head">
                        <div className="mrg mrgtop">
                            <span className="ewallet">Zwallet</span>
                        </div>
                        <div className="mrg mrgtop">
            ...
            <footer className="footer-bg">
                <div className="mrg">
                    <div>
                        <h1 className="p-color footer-h1 h1-home-style">Zwallet</h1>
